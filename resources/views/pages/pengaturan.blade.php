...
<div class="min-h-screen bg-gray-50 py-4 sm:py-6 lg:py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 sm:mb-8">
            <div class="bg-gradient-to-r from-red-800 to-red-800 rounded-lg p-4 sm:p-6 text-white shadow-lg">
                <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold mb-2">Pengaturan Akun</h1>
                <p class="text-red-100 text-sm sm:text-base">Kelola informasi akun dan data pribadi Anda</p>
            </div>
        </div>
                ...
                <form action="{{ route('pengaturan.update') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    ...
                    <div class="text-center border-b border-gray-200 pb-8">
                        ...
                        <div class="flex flex-col items-center space-y-4">
                            <div class="relative group">
                                ...
                                <label for="foto" class="absolute inset-0 rounded-full bg-black bg-opacity-40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300 cursor-pointer">
                                    <div class="bg-red-800 text-white p-3 rounded-full hover:bg-red-700 transition-colors shadow-lg">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="space-y-6">
                                <div class="space-y-2">
                                    ...
                                    @else
                                    <input type="text" name="nama" value="{{ old('nama', $user->nama) }}"
                                           class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:ring-4 focus:ring-red-100 focus:border-red-500 text-sm transition-all duration-200 hover:border-gray-300" required>
                                    @enderror
                                    @error('nama')
                                ...
                                <div class="space-y-2">
                                    ...
                                    @else
                                    <input type="text" name="username" value="{{ old('username', $user->username) }}"
                                           class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:ring-4 focus:ring-red-100 focus:border-red-500 text-sm transition-all duration-200 hover:border-gray-300"
                                           placeholder="Masukkan username (opsional)">
                                    @enderror
                                    @error('username')
                                        <p class="text-red-800 text-xs mt-1 flex items-center">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <textarea name="alamat" rows="4"
                                              class="w-full px-4 py-3 border-2 border-red-500 rounded-lg focus:ring-4 focus:ring-red-100 focus:border-red-500 text-sm transition-all duration-200 bg-red-50 resize-none"
                                              placeholder="Masukkan alamat lengkap">{{ old('alamat', $user->alamat) }}</textarea>
                                    @else
                                    <textarea name="alamat" rows="4"
                                              class="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:ring-4 focus:ring-red-100 focus:border-red-500 text-sm transition-all duration-200 hover:border-gray-300 resize-none"
                                              placeholder="Masukkan alamat lengkap">{{ old('alamat', $user->alamat) }}</textarea>
                                    @enderror
                                    @error('alamat')
                                        <p class="text-red-800 text-xs mt-1 flex items-center">
                    ...
                    <div class="border-t border-gray-200 pt-8">
                        <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-4">
                            ...
                            <button type="submit"
                                    class="w-full sm:w-auto px-6 py-3 bg-red-800 text-white rounded-lg hover:bg-red-700 focus:ring-4 focus:ring-red-100 transition-all duration-200 text-sm font-semibold min-h-[48px] flex items-center justify-center shadow-lg hover:shadow-xl">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">

                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                            ...
                            @if($isAdminKeuangan)
                                ...
                                <button onclick="openApproveModal({{ $pembayaran->id_pembayaran }}, '{{ $pembayaran->penawaran->proyek->kode_proyek }}', '{{ number_format($pembayaran->nominal_bayar, 2, ',', '.') }}', '{{ $pembayaran->vendor->nama_vendor }}')" 
                                ...
                                <button onclick="openRejectModal({{ $pembayaran->id_pembayaran }}, '{{ $pembayaran->penawaran->proyek->kode_proyek }}', '{{ number_format($pembayaran->nominal_bayar, 2, ',', '.') }}', '{{ $pembayaran->vendor->nama_vendor }}')" 

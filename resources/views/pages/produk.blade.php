    ...
    <form method="GET" action="{{ route('purchasing.produk') }}" class="space-y-4">
        <div class="flex flex-col lg:flex-row gap-4">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <a href="{{ route('produk.export', request()->all()) }}" class="px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors flex items-center space-x-2">
        ...
        fetch(`/purchasing/produk/${productId}`)
            ...
            .then(data => {
                if (data.success) {
                    ...
                    // PDN/TKDN/Impor Badge
                    if (document.getElementById('detailPdnTkdn')) {
                    ...
                    if (document.getElementById('detailSkorTkdnContainer')) {
                    ...
                    if (document.getElementById('detailLinkTkdnContainer')) {
                    ...
                    if (document.getElementById('detailEstimasiKetersediaan')) {

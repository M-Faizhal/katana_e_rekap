            ...
            <form id="formEditWilayah" class="space-y-4 sm:space-y-6">
                ...
                <div class="bg-red-50 rounded-lg sm:rounded-xl p-3 sm:p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                        <div>
                            ...
                            <input type="text" id="editWilayah" name="wilayah" class="w-full px-3 py-2 sm:px-4 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 text-sm sm:text-base" placeholder="Contoh: Jakarta Pusat, Bogor" required>
                        </div>
                        <div>
                            <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2">Provinsi <span class="text-red-500">*</span></label>
                            <input type="text" id="editProvinsi" name="provinsi" class="w-full px-3 py-2 sm:px-4 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 text-sm sm:text-base" placeholder="Contoh: DKI Jakarta" required>
                        </div>
                        <div>
                            ...
                            <input type="text" id="editKodeWilayah" name="kode_wilayah" class="w-full px-3 py-2 sm:px-4 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 text-sm sm:text-base" placeholder="Contoh: JKT-01" required maxlength="10">
                        </div>
                        <div>
                            ...
                            <input type="text" id="editInstansi" name="instansi" class="w-full px-3 py-2 sm:px-4 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 text-sm sm:text-base" placeholder="Contoh: Dinas Pendidikan" required>
                        </div>
                        <div class="md:col-span-2">
                            <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2">Deskripsi (Opsional)</label>
                            <textarea id="editDeskripsi" name="deskripsi" rows="2" class="w-full px-3 py-2 sm:px-4 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 text-sm sm:text-base" placeholder="Deskripsi singkat tentang wilayah"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-blue-50 rounded-lg sm:rounded-xl p-3 sm:p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                        <div>
                            ...
                            <input type="text" id="editNamaPejabat" name="nama_pejabat" class="w-full px-3 py-2 sm:px-4 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 text-sm sm:text-base" placeholder="Contoh: Dr. Budi Santoso" required>
                        </div>
                        <div>
                            <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2">Jabatan <span class="text-red-500">*</span></label>
                            <input type="text" id="editJabatan" name="jabatan" class="w-full px-3 py-2 sm:px-4 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 text-sm sm:text-base" placeholder="Contoh: Kepala Dinas" required>
                        </div>
                        <div>
                            <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2">No. Telepon</label>
                            <input type="text" id="editNoTelp" name="no_telp" class="w-full px-3 py-2 sm:px-4 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 text-sm sm:text-base" placeholder="Contoh: 021-123-4567">
                        </div>
                        <div>
                            <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2">Email</label>
                            <input type="email" id="editEmail" name="email" class="w-full px-3 py-2 sm:px-4 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 text-sm sm:text-base" placeholder="Contoh: pejabat@instansi.go.id">
                        </div>
                        <div class="md:col-span-2">
                            <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-1 sm:mb-2">Alamat Kantor</label>
                            <textarea id="editAlamat" name="alamat" rows="2" class="w-full px-3 py-2 sm:px-4 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 text-sm sm:text-base" placeholder="Alamat lengkap kantor instansi"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-yellow-50 rounded-lg sm:rounded-xl p-3 sm:p-6 border-2 border-yellow-200">
                    ...
                    <div class="grid grid-cols-1 gap-3 sm:gap-4">
                        <div>
                            ...
                            <input type="text" id="editAdminMarketingText" name="admin_marketing_text" class="w-full px-3 py-2 sm:px-4 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 text-sm sm:text-base" placeholder="Contoh: Sari Dewi" required>
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-xl p-4">
                    <div class="flex items-start">
                        ...
                        <div>
                            <h4 class="text-sm font-semibold text-gray-800 mb-1">Catatan Penting:</h4>
                            <ul class="text-sm text-gray-600 space-y-1">
                                <li>• Kode wilayah harus unik untuk setiap kombinasi wilayah-instansi</li>
                                <li>• PIC wajib diisi dan akan ditampilkan di badge wilayah</li>
                                <li>• Perubahan data akan mempengaruhi proyek terkait</li>

    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden my-4 mx-auto">
        ...
        <div class="p-6 overflow-y-auto flex-1" style="max-height: calc(100vh - 250px);">
            <div class="text-center mb-6">
                ...
                <p class="text-gray-600 mb-4">Anda akan menghapus potensi berikut:</p>
...
function executeHapus() {
    ...
    const deleteUrl = `/marketing/potensi/${proyekId}`;
    ...
    .then(data => {
        ...
        if (data.success) {
            ...
            if (typeof showSuccessModal === 'function') {
                const kode = currentHapusData.kode || 'Potensi';
                showSuccessModal(`Potensi ${kode} berhasil dihapus dari sistem!`);
            } else {
...
function showSuccessMessage() {
    ...
    const kode = hapusData.kode ? hapusData.kode : 'Potensi';
    showSuccessModal(`Potensi ${kode} berhasil dihapus dari sistem!`);
}

            ...
            <div class="bg-white rounded-lg sm:rounded-2xl overflow-hidden">
                ...
                <div class="p-4 sm:p-6 bg-gradient-to-r from-red-600 to-red-700 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-lg sm:text-xl font-bold">Ubah Status Proyek ke Gagal</h3>
                            <p class="text-red-100 text-sm mt-1">Tandai proyek sebagai gagal dengan memberikan catatan</p>
                        </div>
                    ...
                    <form id="formUbahStatusGagal" class="space-y-6">
                        ...
                        <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                                <div>
                                    ...
                                    <span id="gagalKodeProyek" class="font-medium text-gray-800 ml-2">-</span>
                                </div>
                                <div>
                            ...
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-red-700 text-sm">
                                        Mengubah status proyek menjadi "Gagal" akan menandai proyek ini sebagai tidak berhasil. 
                        ...
                        <div>
                            ...
                            <textarea id="catatanGagal" name="catatan" rows="4"
                                    ...
                                    placeholder="Jelaskan alasan mengapa proyek ini dianggap gagal. Minimal 5 karakter."
                                    minlength="5"
                                    maxlength="1000"
                                    required></textarea>
                        ...
                        <!-- Hidden inputs -->
                        <input type="hidden" id="proyekIdGagal" name="proyek_id" value="">
                    </form>
                </div>
...
<script>
let currentProyekIdGagal = '';

function ubahStatusGagal(proyekId) {
    currentProyekIdGagal = proyekId;
    ...
    document.getElementById('gagalKodeProyek').textContent = proyek.kode;
    document.getElementById('gagalNamaInstansi').textContent = proyek.instansi;
    ...
    // Set hidden input
    document.getElementById('proyekIdGagal').value = proyekId;
...
function submitStatusGagal() {
    ...
    // Send request
    fetch(`/marketing/proyek/${currentProyekIdGagal}/status-gagal`, {
        method: 'POST',
        headers: {
    ...
    .then(data => {
        if (data.success) {
            ...
            const proyek = proyekData.find(p => p.id == currentProyekIdGagal);
            if (proyek) {
                proyek.status = 'gagal';
            }
            ...
            showSuccessModal('Status proyek berhasil diubah menjadi Gagal!');
            ...
            alert(data.message || 'Terjadi kesalahan saat mengubah status proyek!');
        }
    })
    .catch(error => {

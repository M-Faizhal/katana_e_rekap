    ...
    public function toArray(object $notifiable): array
{
    ...
    $vendorNama = $this->pembayaran->vendor?->nama_vendor ?? $this->pembayaran->id_vendor ?? '-'; // [tl! highlight]

    return [
        'event' => 'pembayaran_submitted',
        'title' => 'Pembayaran Menunggu Approval',
        'message' => 'Ada pembayaran baru yang menunggu approval untuk vendor ' . $vendorNama . ' dari Proyek ' . $kodeProyek . ' oleh ' . $namaPurchasing . '.', // [tl! highlight]
